...
status: active
owner: team-data
tags: [artifact/artifact-pipeline, domain/etl, domain/datalake, layer/howto, audience/dev, audience/ops, privacy/internal, language/it]
entities: []
llm:
  include: true
  pii: none
...
[Home](../../scripts/docs/project-root/DEVELOPER_START_HERE.md) > [[domains/datalake|datalake]] > [[Layer - Howto|Howto]]
