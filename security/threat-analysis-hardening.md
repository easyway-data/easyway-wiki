...
Vedi: [AI Security Guardrails](./ai-security-guardrails.md)
...
- ✅ AI Security guardrails documentati ([ai-security-guardrails.md](./ai-security-guardrails.md))
...
- [Oracle Current Environment](../../docs/ORACLE_CURRENT_ENV.md)
